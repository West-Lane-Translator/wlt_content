...
| To find out what the actual SNR value of channel 35 (9) is, press the circled arrow pointing down at the bottom of the screen.  Alternatively you could press the circled arrow pointing up four times.  The selected channel will change to be 35 (9) and the signal level and SNR will be displayed for it.  In the screen shown to the right, note that the SNR is marginal at 22.7 dB.  You can try to improve it by repositioning the antenna as you monitor the meter.  Even if it can not be improved, you will probably be satisfied with your reception of channel 35 (9) at the time but you may lose reception of it under worse conditions.  Changing your [antenna]({filename}Antennas.md) to one rated for a longer range should improve the SNR. | [![Meter SNR Screen]({static}/images/meter_snr_35.jpg)]({static}/images/meter_snr_35.jpg) |
