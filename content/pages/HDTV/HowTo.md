...
so that you can click on the links and see larger versions of the pictures.
...
We broadcast from a tower that is on the top of Parachute Hill across the
Siuslaw River from Old Town Florence.  You can probably get by with a simple
[UHF indoor antenna]({filename}../HDTV/Antennas.md#indoor-antennas) pointing
at the towers if you can see the towers from where the antenna will be.
Antennas like these are also available locally and on the internet.

An [indoor antenna]({filename}../HDTV/Antennas.md#indoor-antennas) pointing in
the general direction of the towers may work if you aren't too far away from
the tower and there aren't too many obstacles (e.g. trees) between you and the
tower.  As the distance or number of obstacles increase, it becomes likely
that you will need to use a carefully aimed [UHF outdoor
antenna]({filename}../HDTV/Antennas.md#outdoor-antennas) connected to your TV
with a length of [cable]({filename}Antennas.md#antenna-cables).
...
HDTV is transmitted digitally and its reception also tends to be very digital;
either you are receiving wonderful picture and sound or you are receiving
nothing.  If you are receiving nothing, it can be a challenge to know if you
have a problem with your cabling, the direction your antenna is pointing or if
you need a longer range antenna.  Even if you are receiving HDTV channels, it
is difficult to know how well you are receiving it.  If your received signal
level is marginal, you may not receive channels when conditions change.  As
mentioned previously, trees reduce signals and when their canopies become
saturated with rain water, the signals are reduced even more.

## A Signal Meter Helps Overcome the Challenge
...
The meter provides a way to show the quality of the received signal for all of
the channels we broadcast all at the same time.  In addition, it is highly
portable because it is small and is powered by an internal rechargeable
battery.
...
* the GE Pro Bar HD antenna with an attached 66" long cable,
...
The included antenna can be used with the meter or your TV to get an idea of
how well a simple indoor antenna will receive WLT's HDTV channels in your
location.

## Using the Meter

To make the most of the meter, you'll have to know about some esoteric
things such as SNR and dB, but these instructions will try to make
using the meter easy by walking you through it step by step.  Each
picture can be clicked on to see it larger.

### Charging the Meter

When you get the kit home, it would be a good idea to ensure the meter's
battery is charged.  *Please also charge the battery before you return the
meter.*
...
| Open the plastic lid on the top of the meter. | [![Opening the meter lid]({static}/images/meter_lid.jpg)]({static}/images/meter_lid.jpg) |
...
| After the meter is powered on, its home screen is displayed.  The screen is a touch screen which works best when it is touched with the stylus included in the kit.  If the large vertical button on the left side of the screen shows **CATV**, press it with the stylus to change it to say **ATSC**.  The image at right shows the meter in the correct ATSC mode. | [![Meter ATSC button]({static}/images/meter_atsc.jpg)]({static}/images/meter_atsc.jpg) |
...
The meter shows how well a channel is being received with two different
values:

**LEVEL**

The signal level is basically how "loud" the signal is.  The meter displays
the signal level in dBm.  If you accidentally touch the word **dBm** on the
screen, the meter will switch to displaying dBmv.  This document uses dBm so
just press the stylus on the word **dBmv** on the screen and the meter will
flip back to using dBm.

A good signal level is typically be between -35 dBm and -70 dBm.  Note that
these values are negative and higher values are better so -35 dBm is better
than -70 dBm.  The other important thing to know is that dBm measurements are
logarithmic.  That means that small changes in dBm values can indicate a large
change in the signal level.  A 3 dBm improvement (e.g. from -60 dBm to -57
dBm) means the signal level has been improved twofold.  A 10 dBm improvement
(e.g. from -60 dBm to -50 dBm) means the signal level has been improved
tenfold.

The signal level can be boosted with antenna amplifiers to overcome signal
loss due to long cable runs or splitting the signal to multiple TVs.

**SNR**

SNR is an abbreviation for Signal-to-Noise Ratio.  As an analogy, if you think
of listening to a radio station, SNR measures how well you can hear the music
over the static.  SNR is measured in dB.

SNR values over 25 dB are ideal and values under 20 dB mean the signal is
practically unusable.  The values are positive but dB units are also
logarithmic so once again, 23 dB is two times better than 20 dB and 30 dB is
10 times better than 20 dB.

If the signals from your antenna have poor SNR values, an antenna amplifier
will *not* improve it.  Going back to the radio station analogy, if you are
only hearing static, turning up the volume will not help receive the station.

**Summary**

You need to have SNR values of at least 20 dB and preferably over 25 dB for
all the channels when the meter is connected directly to the antenna.  At your
TV set(s), the SNR values need to be in the same range and the signal level
needs to be between -35 dBm and -70 dBm.

As mentioned in a note on the [HDTV Channels]({filename}../HDTV.md) page,
subchannels are available for each HDTV channel.  The main channel and
subchannels are all part of the same digital transmission so the level and SNR
will be identical for all of them.  The meter displays information about
channels without the decimal suffixes because of this.

If you would like more information, [this blog post by the retailer
Solid
...
The meter displays how well the signals are being received on three different
screens that are selected by using the stylus to press **LEVEL**, **SCAN** or
**SNR** on the home screen.  You can return to the home screen from these
screens by either tapping the power button twice or using the stylus to press
the lower-left button on the screen that looks like a house.
...
| On this screen, set V# to 9 for C# 35 and turn on the check mark for C# 35 and verify against the image shown to the right.  Press the circular arrow at the bottom of the screen and then press "YES" when asked if the Channel Plan should be saved.  The meter has now been set to show just the Florence WLT channels with their equivalent Eugene channels.  Quickly press the power button twice to return to the home screen. | [![Meter Files ATSC Plan Ch 2]({static}/images/meter_atsc_plan34.jpg)]({static}/images/meter_atsc_plan34.jpg) |
